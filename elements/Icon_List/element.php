...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\IconList",
...
class IconList extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Position",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'flex-start', 'text' => 'Top', 'icon' => 'FlexAlignTopIcon'], ['value' => 'center', 'text' => 'Bottom', 'icon' => 'FlexAlignCenterVerticalIcon'], ['value' => 'flex-end', 'text' => 'Bottom', 'icon' => 'FlexAlignBottomIcon']]],
        false,
        false,
        [],
        ...
        "Stack",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['text' => 'Vertical', 'value' => 'vertical'], ['value' => 'horizontal', 'text' => 'Horizontal']]],
        false,
        false,
        [],
        ...
        "Horizontal Align",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'space-between', 'text' => 'Between'], ['text' => 'Around', 'value' => 'space-around'], ['text' => 'Center', 'value' => 'center'], ['text' => 'Start', 'value' => 'flex-start'], ['text' => 'End', 'value' => 'flex-end']], 'condition' => ['path' => 'design.layout.stack', 'operand' => 'equals', 'value' => 'horizontal']],
        false,
        false,
        [],
        ...
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'left', 'text' => 'Left', 'icon' => 'AlignLeftIcon'], ['text' => 'Center', 'value' => 'center', 'icon' => 'AlignCenterIcon'], ['text' => 'Right', 'value' => 'right', 'icon' => 'AlignRightIcon']]],
        false,
        false,
        [],
